...
export default function Login() {
  ...
  async function signIn(event: React.FormEvent) {
    ...
    if (signInError) setError(signInError.message);
      ...
      if (!remember) sessionStorage.setItem("echo-session-only", "true");
